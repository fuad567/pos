...
<html lang="en">
  <head>
    ...
    <title>Tambah Produk - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    ...
    <div class="container" style="padding-bottom: 100px">
	  ...
	  <h6 style="padding-left:15px;padding-right:15px;font-size:18px">Formulir Tambah Produk</h6>
	  </div>
      <form class="form-group" action="tambah_pr.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            <label>Nama Produk</label> <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Produk" required><br />
            <label>Warna</label> <input type="text" name="warna" class="form-control" placeholder="Masukkan Warna" required><br />
            <label>Jumlah</label> <input type="text" name="jumlah" class="form-control" placeholder="Masukkan Jumlah" required><br />
            
          </div>
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            <label>Harga</label> <input type="text" name="harga" class="form-control" placeholder="Masukkan Harga" required><br />
            ...
            <label>Merk</label> <br />
					...
					<?php
						...
						<option value="<?php echo $hasil['id_merk']; ?>"><?php echo $hasil['nama_merk']; ?></option>
					<?php } ?>
					</select><br />
