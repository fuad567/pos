...
<html lang="en">
  <head>
    ...
    <title>Edit Data Pelanggan - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    ...
    <div class="container" style="padding-bottom: 100px">
      ...
      <h6 style="padding-left:15px;padding-right:15px;font-size:18px">Formulir Edit Data Pelanggan</h6>
      </div>
            <?php
      ...
      <form class="form-group" action="edit_p.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            <input type="text" name="id" value="<?php echo $row['id_pelanggan']; ?>" hidden>
            <label>Nama</label> <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama" value="<?php echo $row['nama_pelanggan']; ?>" required><br />
          ...
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
             <label>Username</label> <input type="text" name="username" class="form-control" placeholder="Masukkan Username" value="<?php echo $row['username']; ?>" required><br />
            <label>Password</label> <input type="password" name="password" class="form-control" placeholder="Masukkan Password" value="<?php echo $row['password']; ?>" required><br />
            
            
          </div>
          <div class="col-md-12" style="padding-top:20px; padding-left:25px;padding-right:25px">
            <label>Alamat</label> <textarea name="alamat" class="form-control" required rows="5" placeholder="Masukkan Alamat"><?php echo $row['alamat']; ?></textarea><br />
            <button type="submit" class="btn btn-primary shadowb">Perbarui</button> &nbsp;<button type="reset" class="btn btn-danger shadowb">Reset</button> &nbsp;<a href="data_pelanggan.php"><span class="btn btn-warning shadowb">Kembali</span></a>
          </div>
        </div>
      </form>
    </div>
