...
<html lang="en">
  <head>
    ...
    <title>Tambah Kategori Produk - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    ...
    <div class="container" style="padding-bottom: 100px">
      ...
      <h6 style="padding-left:15px;padding-right:15px;font-size:18px">Formulir Penambahan Data Kategori Produk</h6>
      </div>
      <form class="form-group" action="tambah_k.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-12" style="padding-left:25px;padding-right:25px">
            <label>Nama Kategori</label> <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Kategori" required><br />
            
            <button type="submit" class="btn btn-primary shadowb">Simpan</button> &nbsp;<button type="reset" class="btn btn-danger shadowb">Reset</button> &nbsp;<a href="data_kategori.php"><span class="btn btn-warning shadowb">Kembali</span></a>
          </div>
        </div>
      </form>
    </div>
