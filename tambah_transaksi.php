...
<html lang="en">
  <head>
    ...
    <title>Tambah Transaksi - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    <div class="container-fluid shadowb" style="padding:0px">
      <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(to right, #000099 0%, #7575a3 100%)!important">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-0 my-lg-0" action="data_transaksi.php" method="get">
            <input class="form-control mr-sm-0" style="border-radius:0rem;background-color:#f0f0f5" name="cari" type="search" placeholder="Cari Data Transaksi" aria-label="Search">
    ...
    <div class="container" style="padding-bottom: 100px">
	  ...
	  <h6 style="padding-left:15px;padding-right:15px;font-size:18px">Formulir Tambah Transaksi</h6>
	  </div>
      <form class="form-group" action="tambah_t.php" method="post">
          ...
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
          	<label>Nama Pelanggan</label> <br />
                <select class="form-control" name="id_pelanggan">
                	<option selected="" value="noname" style="color:gray">Pilih Nama Pelanggan</option>
					<?php
						include 'koneksi.php';
            ...
            <label>Item Produk</label> <br />
                <select class="form-control" name="id_produk">
                	<option selected="" value="noname" style="color:gray">Pilih Nama Produk</option>
					<?php
						include 'koneksi.php';
            ...
            <label>Jumlah Barang</label> <input type="text" name="jumlah" class="form-control" placeholder="Masukkan Jumlah Barang" required><br />
            
          </div>
          <div class="col-md-6" style="padding-left:25px;padding-right:25px">
            <label>Tanggal Transaksi</label> <input type="text" name="tanggal_transaksi" class="form-control" value="<?php echo date('Y-m-d'); ?>" readonly required><br />
           
            <label>Diskon / Promo</label> <br />
                <select class="form-control" name="diskon">
                	<option selected="">0 %</option>
					
					</select><br />
           <label>Total Transaksi</label> <input type="text" name="total_transaksi" value="Harga Produk * Jumlah Barang" readonly="" class="form-control">
           
          </div>
          <div class="col-md-12" style="padding-top:20px; padding-left:25px;padding-right:25px">
            
            <button type="submit" class="btn btn-primary shadowb">Simpan</button> &nbsp;<button type="reset" class="btn btn-danger shadowb">Reset</button> &nbsp;<a href="data_transaksi.php"><span class="btn btn-warning shadowb">Kembali</span></a>
          </div>
        </div>
      </form>
    </div>
