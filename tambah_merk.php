...
<html lang="en">
  <head>
    ...
    <title>Tambah Merk - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    ...
    <div class="container" style="padding-bottom: 100px">
      ...
      <h6 style="padding-left:15px;padding-right:15px;font-size:18px">Formulir Penambahan Data Merk Produk</h6>
      </div>
      <form class="form-group" action="tambah_m.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-12" style="padding-left:25px;padding-right:25px">
            <label>Nama Merk</label> <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Merk" required><br />
