...
<html lang="en">
  <head>
    ...
    <title>Edit Data Merk Produk - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
    ...
    <div class="container" style="padding-bottom: 100px">
      ...
      <h6 style="padding-left:15px;padding-right:15px;font-size:18px">Formulir Edit Data Merk Produk</h6>
      </div>
            <?php
      ...
      <form class="form-group" action="edit_m.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-12" style="padding-left:25px;padding-right:25px">
            <input type="text" name="id" value="<?php echo $row['id_merk']; ?>" hidden>
            <label>Nama</label> <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama" value="<?php echo $row['nama_merk']; ?>" required><br />
