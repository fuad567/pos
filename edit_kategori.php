...
<html lang="en">
  <head>
    ...
    <title>Edit Data Kategori Produk - Digital Talent</title>
  </head>
  <body style="background-color:#c2c2d6">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(to right, #000099 0%, #7575a3 100%)!important">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-0 my-lg-0" action="data_kategori.php" method="get">
            <input class="form-control mr-sm-0" style="border-radius:0rem;background-color:#f0f0f5" name="cari" type="search" placeholder="Cari Data Kategori" aria-label="Search">
    ...
    <div class="container" style="padding-bottom: 100px">
      ...
      <h6 style="padding-left:15px;padding-right:15px;font-size:18px">Edit Data Kategori Produk</h6>
      </div>
            <?php
      ...
      <form class="form-group" action="edit_k.php" method="post">
        <div class="row shadowb" style="padding-top:25px;padding-bottom: 35px;background-color:#7575a3;color:white">
          <div class="col-md-12" style="padding-left:25px;padding-right:25px">
            <input type="text" name="id" value="<?php echo $row['id_kategori']; ?>" hidden>
            <label>Nama</label> <input type="text" name="nama" class="form-control" placeholder="Masukkan Nama" value="<?php echo $row['nama_kategori']; ?>" required><br />
